  ...
  it('passes for a well-contrasted theme', () => {
    const theme: ThemeConfig = {
      ...
      colors: {
        ...
        error: { DEFAULT: 'oklch(50% 0.2 27)', foreground: 'oklch(98% 0 0)' },
        errorFocus: 'oklch(45% 0.2 27)',
        primaryFocus: 'oklch(40% 0.15 285)',
